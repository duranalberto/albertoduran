...
description: "A semantic color token travels from DaisyUI's OKLCH themes through Tailwind utilities, component surfaces, and Mermaid palettes."
...
Mermaid SVG assets still need careful theme handling, which the Mermaid section explains in detail. The design point is simpler. Diagrams are part of the visual system, so they need theme-aware colors too.

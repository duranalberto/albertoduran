...
| Family                   | Fence types                                                                                 |
| ------------------------ | ------------------------------------------------------------------------------------------- |
| Common comparison        | `line`, `area`, `bar`, `pie`, `donut`, `rose`, `scatter`                                    |
| Density and distribution | `histogram`, `heatmap`, `correlation-heatmap`, `boxplot`                                    |
| Hierarchy and flow       | `treemap`, `sankey`                                                                         |
| Market views             | `candlestick-volume`, `macd`, `rsi`, `bollinger-bands`                                      |
| Market structure         | `depth`, `order-book`, `ohlc`                                                               |
| Escape hatch             | `option` for raw JSON-compatible ECharts options when a preset cannot express the chart yet |
...
| ---------------- | --------------------------------------------------------------------------------------- |
| `implementation` | How does an `echart` fence turn MDX data into static SVG and optional enhancement.      |

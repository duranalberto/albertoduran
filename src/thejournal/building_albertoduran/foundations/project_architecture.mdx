...
description: "A practical tour of the albertoduran.com source tree, route surface, and shared Astro layout boundaries."
...
The layout receives a `siteManifest` and optional image. It computes preferred URLs from `Astro.url.pathname`, creates an optimized social image with `getImage()`, and registers Open Graph and Twitter metadata.

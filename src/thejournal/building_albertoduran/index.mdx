...
description: "A technical case study of an Astro publishing product, including its build boundaries, reader experience, evidence, and unresolved risks."
...
albertoduran.com presents my work through a portfolio, project case studies, and a long-form technical journal. That public surface looks straightforward. Building it meant solving a less visible problem. The site had to keep rich articles, diagrams, charts, navigation, and a professional profile readable across devices without turning every visit into a client-rendered application. This vault follows the decisions, compromises, and unfinished work behind that result.

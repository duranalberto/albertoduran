...
> Current evidence boundary. The deterministic build proves that static pages and assets can be generated. It also reports at least one minified JavaScript chunk above 500 kB. Performance claims need measurements, and the chunk warning remains an open item rather than a detail to edit away.

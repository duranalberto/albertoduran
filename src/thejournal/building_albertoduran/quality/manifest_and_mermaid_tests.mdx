...
description: "How Vitest covers the journal manifest, Mermaid transform pipeline, ECharts chart pipeline, HTML minifier, Atlas loader, and custom build logic."

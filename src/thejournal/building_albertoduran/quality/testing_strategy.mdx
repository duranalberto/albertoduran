...
Vitest covers the code that can be tested without a full browser. That includes manifest building, navigation helpers, Mermaid HAST utilities, Mermaid transform behavior, Mermaid page CSS hoisting, ECharts SSR and option helpers, the custom HTML minifier, the Atlas loader, and SVG ribbon generation.

...
description: "Theme correctness has three deadlines around first paint, user choice, and Astro route swaps, each owned by a different layer."
...
## Protect all three theme moments

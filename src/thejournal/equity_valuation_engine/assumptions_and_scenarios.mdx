...
<EChart
  ...
  option={{
    ...lineChartOption({
      ...
      y: [7.7, 6.5, 5.3, 4.1, 3.0],
      name: "Base",
    }),
    series: [
      { type: "line", name: "Bear", data: [4.7, 4.3, 3.9, 3.4, 3.0] },
      { type: "line", name: "Base", data: [7.7, 6.5, 5.3, 4.1, 3.0] },
      { type: "line", name: "Bull", data: [10.7, 8.8, 6.9, 4.9, 3.0] },
    ],
...
<Callout variant="warning" title="Illustrative defaults">
  <p>The audited YAML includes multiples, discount inputs, growth limits, and asset haircuts without a complete source artifact, retrieval date, or formal update cadence. Treat them as project policy, not verified current sector medians.</p>
</Callout>

...
```daisyui
{
  "component": "callout",
  "variant": "caution",
  "title": "WACC must exceed terminal growth",
  "content": [
    {
      "type": "paragraph",
      "text": "When WACC is equal to or below perpetual growth, the Gordon Growth denominator is zero or negative. The output is not an economically useful terminal value."
    }
  ]
}
```

...
```daisyui
{
  "component": "callout",
  "variant": "warning",
  "title": "Early project boundaries",
  "content": [
    {
      "type": "paragraph",
      "text": "The package is version 0.1.0 and has no visible license, contribution guide, changelog, security policy, or second repository adapter. Confirm usage rights and expectations before distributing modifications."
    }
  ]
}
```

...
<MockupWindow aria-label="Fictional valuation summary" bodyClass="p-5 font-mono text-sm">
  <strong slot="header">Anonymous sample summary</strong>
  <pre className="overflow-x-auto whitespace-pre-wrap">{`Current price                 $50.00
Models run                         5
Models skipped                    2
...
Dispersion band          $41.83 to $60.57`}</pre>
  <span slot="caption">A fictional teaching fixture shaped like the engine output, not a live market result.</span>
</MockupWindow>
...
<Callout variant="warning" title="Educational software, not investment advice">
  <p>This project organizes valuation calculations and diagnostics. It does not know your objectives, constraints, tax position, portfolio, or tolerance for loss. Verify source filings and assumptions before relying on any output.</p>
</Callout>

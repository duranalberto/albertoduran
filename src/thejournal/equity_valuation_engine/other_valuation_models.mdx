...
import { barChartOption } from "@integrations/echarts/options";
...
<Callout variant="warning" title="Historical P/E limitation">
  <p>The current source pairs daily prices with annual EPS values by list position. The central comparison excludes P/E until observations are aligned by date and covered by direct valuation tests.</p>
</Callout>

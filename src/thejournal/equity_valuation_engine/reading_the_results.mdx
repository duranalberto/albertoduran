...
<MockupWindow aria-label="Fictional scenario result" bodyClass="p-5 font-mono text-sm">
  <strong slot="header">Anonymous scenario table</strong>
  <pre className="overflow-x-auto whitespace-pre-wrap">{`Model           Bear       Base       Bull
DCF           $42.00     $58.00     $74.00
ROE           $44.00     $53.00     $63.00
EV/EBITDA     $39.00     $48.00     $57.00
P/S           $48.00     $62.00     $76.00
NAV           $28.00     $35.00     $42.00`}</pre>
  <span slot="caption">Rows show scenario sensitivity. Columns allow cross-model comparison.</span>
</MockupWindow>
...
<Callout variant="information" title="Use the narrower label">
  <p>Call this interval the model dispersion band. It measures how far included Base estimates spread around their equal-weight average. It does not estimate where true value probably lies.</p>
</Callout>
